...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/style-error.scss', 'public/css') }}">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <p>La página que buscas no existe. Cómo llegaste aquí es un misterio. Pero puede hacer clic en el
                        botón de abajo para volver a la página de inicio.
                    </p>
                    <a class="btn-error" href="/">Regresar</a>
                </div>
            </div>
        </div>
    </main>
