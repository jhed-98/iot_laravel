        ...
        <div x-data="{ status_type: @entangle('status_type') }">
            ...
            <x-table-responsive-up>
                <div class="box-header px-4">
                    ...
                    <h3 class="px-4 box-title">Responsive Table Abono</h3>
                ...
                <div class="box-body table-responsive no-padding  ">
                    @if ($alkalinities->count())
                        <table class="table table-hover">
                            <tr>
                                <th>ID</th>
                                <th>Nivel alkalinity</th>
                                <th>Estacion</th>
                                <th>Fecha </th>
                                <th>Options</th>
                            </tr>
                            @foreach ($alkalinities as $item)
                                <tr>
                                    ...
                                    @endswitch
                                    <td>
                                        @if (Risk::where('sensor_id', $item->id)->first())
                                            <div class="flex flex-col">
                                                <div class="flex justify-start items-center">
                                                    <x-jet-label value="Registrado:" />
                                                    <span
                                                        class="px-2">{{ date('d/m/Y g:i a', strtotime(Risk::where('sensor_id', $item->id)->value('created_at'))) }}
                                                    </span>
                                                </div>
                                                <div class="flex justify-start items-center">
                                                    <x-jet-label value="Actualizado:" />
                                                    <span class="px-2">
                                                        {{ date('d/m/Y g:i a', strtotime(Risk::where('sensor_id', $item->id)->value('updated_at'))) }}
                                                    </span>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @switch($item->status_alkalinity)
                                            @case(0)
                                                <button
                                                    ...
                                                    <i class="fa fa-fw fa-edit"></i> Registro Abono
                                                </button>
                                            @break
                                            ...
                                            @case(1)
                                                <button
                                                    ...
                                                    <i class="fa fa-fw fa-edit"></i> Actualizar Abono
                                                </button>
                                            @break
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2">
                                            <div class="px-2 py-2 ">
                                                <div>
                                                    <label for="input_encargado">Bono para emplear</label>
                                                    {{-- <select class="w-full form-control select2edit" --}}
                                                    <select class="w-full form-control"
                                                        wire:model="createForm.risk_name">
                                                        <option value="" selected>Seleccione tipo de abono</option>
                                                ...
                                                <x-jet-input-error for="createForm.risk_name" />
                                            </div>

                                            <div class="px-2 py-2">
                                                <label for="risk_quantity">Cantidad de abono</label>
                                                <input wire:model.defer="createForm.risk_quantity" type="text"
                                                    class="form-control" id="risk_quantity"
                                                    onkeypress='javascript: return isNumber (event)'>
                                                <x-jet-input-error for="createForm.risk_quantity" />
                                            </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2">
                                            <div class="px-2 py-2 ">
                                                <div>
                                                    <label for="input_encargado">Bono para emplear</label>
                                                    {{-- <select class="w-full form-control select2edit" --}}
                                                    <select class="w-full form-control" wire:model="editForm.risk_name">
                                                        <option value="" disabled selected>Seleccione tipo de abono
                                                        </option>
                                                ...
                                                <x-jet-input-error for="editForm.risk_name" />
                                            </div>

                                            <div class="px-2 py-2">
                                                <label for="risk_quantity">Cantidad de abono</label>
                                                <input wire:model.defer="editForm.risk_quantity" type="text"
                                                    class="form-control" id="risk_quantity"
                                                    onkeypress='javascript: return isNumber (event)'>
                                                <x-jet-input-error for="editForm.risk_quantity" />
                                            </div>
